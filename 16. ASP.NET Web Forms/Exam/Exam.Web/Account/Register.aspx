...
<%--                <asp:RequiredFieldValidator runat="server" ControlToValidate="LastName"
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <asp:TextBox runat="server" ID="YoutubeUrl" CssClass="form-control" TextMode="Singleline" />
<%--                <asp:RequiredFieldValidator runat="server" ControlToValidate="LastName"
                    CssClass="text-danger" ErrorMessage="The last name field is required." />--%>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-10">
                <asp:TextBox runat="server" ID="FacebookUrl" CssClass="form-control" TextMode="Singleline" />
<%--                <asp:RequiredFieldValidator runat="server" ControlToValidate="LastName"
                    CssClass="text-danger" ErrorMessage="The last name field is required." />--%>
            </div>
        </div>
